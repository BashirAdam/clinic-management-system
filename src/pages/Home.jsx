    ...
    <div className="home-landing">
      ...
      <style>{`
        .home-landing {
          ...
          display: grid;
          place-items: center;
          background: linear-gradient(120deg, #FDFBF7, #D4E2C8);
        ...
        .home-landing .mark::before { background: radial-gradient(circle at 50% 50%, #6B8E5E, transparent 65%); opacity: 0.6; }
        ...
        .home-landing p { margin: 0 auto 18px; font-size: clamp(14px, 2.4vw, 16px); color: #4A6B3E; max-width: 46ch; line-height: 1.5; animation: fadeInUp 900ms ease 120ms both; }
        .home-landing .loader { width: 44px; height: 44px; margin: 18px auto 0; border-radius: 50%; border: 3px solid rgba(107, 142, 94, 0.22); border-top-color: #6B8E5E; animation: spin 1s linear infinite; }
        .home-landing .hint { margin-top: 16px; font-size: 12px; color: #4A6B3E; animation: fadeIn 1.2s ease 500ms both; }
