...
export default function ViewPrescription() {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case 'completed': return 'text-sage-600 bg-blue-400/10'
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-sage-50 via-sage-100 to-white text-sage-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sage-700 mt-4">Loading prescription...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-sage-50 via-sage-100 to-white text-sage-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sage-700">Prescription not found</p>
          <Link
            to="/doctor/prescriptions"
            className="mt-4 inline-flex items-center space-x-2 px-4 py-2 bg-sage-500 hover:bg-sage-600 text-white rounded-lg transition-colors"
          >
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-sage-700">View prescription information</p>
            </div>
          </div>
          <div className="flex items-center space-x-3">
            <button
            ...
            <button
              onClick={handlePrint}
              className="flex items-center space-x-2 px-4 py-2 bg-sage-500 hover:bg-sage-600 text-white rounded-lg transition-colors"
            >
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl">
            <div className="flex justify-between items-start mb-4">
              <div>
                ...
                <p className="text-sage-700">Prescription ID: {prescription.id}</p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              ...
              <div>
                <span className="text-sage-700">Doctor:</span>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl">
            ...
            <div className="space-y-4">
              {prescription.diagnosis && (
                <div>
                  <h4 className="text-sm font-medium text-sage-700 mb-2">Diagnosis:</h4>
              ...
              {prescription.symptoms && (
                <div>
                  <h4 className="text-sm font-medium text-sage-700 mb-2">Symptoms:</h4>
                ...
                <div key={medicine.id || index} className="bg-white/5 border border-white/10 rounded-lg p-4">
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      ...
                      <p className="text-sage-700">{medicine.category}</p>
                    </div>
                    <span className="text-sm text-sage-700">#{index + 1}</span>
                  </div>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
                    <div>
                      <span className="text-sage-700">Dosage:</span>
                      <span className="ml-2 text-white">{medicine.dosage}</span>
                    </div>
                    <div>
                      <span className="text-sage-700">Frequency:</span>
                      <span className="ml-2 text-white">{medicine.frequency}</span>
                    </div>
                    <div>
                      <span className="text-sage-700">Duration:</span>
                      <span className="ml-2 text-white">{medicine.duration}</span>
                    </div>
                    <div>
                      <span className="text-sage-700">Timing:</span>
                  ...
                  {medicine.specialInstructions && (
                    <div className="mt-3">
                      <span className="text-sage-700 text-sm">Special Instructions:</span>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl">
            ...
            <div className="space-y-4">
              {prescription.instructions && (
                <div>
                  <h4 className="text-sm font-medium text-sage-700 mb-2">General Instructions:</h4>
              ...
              {prescription.followUpDate && (
                <div>
                  <h4 className="text-sm font-medium text-sage-700 mb-2">Follow-up Date:</h4>
              ...
              {prescription.notes && (
                <div>
                  <h4 className="text-sm font-medium text-sage-700 mb-2">Additional Notes:</h4>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl">
            <div className="flex justify-between items-center">
              <div>
                <p className="text-sm text-sage-700">Prescribed on: {prescription.prescriptionDate}</p>
                <p className="text-sm text-sage-700">Doctor: {prescription.doctorName}</p>
              </div>
              <div className="text-right">
                <p className="text-sm text-sage-700">Prescription ID</p>
