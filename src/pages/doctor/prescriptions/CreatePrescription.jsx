         ...
         {initialLoading ? (
           <div className="flex items-center justify-center min-h-96">
             <div className="text-center">
               ...
               <p className="text-sage-700">Loading prescription data...</p>
             </div>
           </div>
         ) : (
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl">
            <h2 className="text-lg font-semibold mb-4 flex items-center space-x-2">
              ...
              <span>Patient Information</span>
               ...
               <div>
                 <label className="block text-sm font-medium text-sage-700 mb-2">Select Patient</label>
              ...
              <div>
                <label className="block text-sm font-medium text-sage-700 mb-2">Prescription Date</label>
                <input
                  type="date"
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-sage-700 mb-2">Diagnosis</label>
                <textarea
              ...
              <div className="mb-4" ref={medicineDropdownRef}>
                ...
                <div className="mt-2 max-h-60 overflow-y-auto bg-slate-800 border border-white/10 rounded-lg shadow-xl">
                  {filteredMedicines.length > 0 ? (
                    ...
                    <div className="px-4 py-3 text-sage-700 text-center">
                ...
                <div key={medicine.id} className="bg-white/5 border border-white/10 rounded-lg p-4">
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      ...
                      <p className="text-sm text-sage-700">{medicine.category}</p>
                    </div>
                    <button
                      type="button"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-sage-700 mb-1">Frequency</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-sage-700 mb-1">Duration</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-sage-700 mb-1">Timing</label>
                      <select
                  ...
                  <div className="mt-3">
                    <label className="block text-sm font-medium text-sage-700 mb-1">Special Instructions</label>
                    <input
                      type="text"
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-sage-700 mb-2">General Instructions</label>
                <textarea
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-sage-700 mb-2">Follow-up Date</label>
                  <input
                    type="date"
           ...
           <div className="bg-slate-800 border border-white/10 rounded-2xl shadow-2xl w-full max-w-2xl max-h-[80vh] overflow-hidden">
             ...
             <div className="flex justify-between items-center p-6 border-b border-white/10">
               ...
               <button
                 ...
                 className="text-sage-700 hover:text-white transition-colors"
               >
                 <X className="w-6 h-6" />
               </button>
             </div>
             ...
             <div className="flex-1 overflow-y-auto max-h-96">
               {filteredPatients.length > 0 ? (
                   ...
                   >
                     <div className="flex justify-between items-start">
                       <div className="flex-1">
                         ...
                         <div className="text-sage-700 mt-1">
                 ...
                 <div className="p-8 text-center">
                   <div className="text-sage-700 text-lg mb-2">
