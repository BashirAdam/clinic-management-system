...
export default function Medicines() {
  ...
  const getCategoryColor = (category) => {
    switch (category) {
      ...
      case 'diabetes': return 'text-sage-600 bg-blue-400/10'
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-sage-700">Add, edit, and manage medicine inventory</p>
            </div>
          </div>
          <div className="flex items-center space-x-3">
            <button
      ...
      <main className="max-w-7xl mx-auto p-6">
        ...
        {loading ? (
          <div className="bg-white/5 border border-white/10 rounded-2xl p-8 text-center">
            ...
            <p className="text-sage-700 mt-4">Loading medicines...</p>
          </div>
        ) : filteredMedicines.length === 0 ? (
          <div className="bg-white/5 border border-white/10 rounded-2xl p-8 text-center">
            <Pill className="w-16 h-16 text-sage-700 mx-auto mb-4" />
            <p className="text-sage-700">No medicines found</p>
          </div>
        ) : (
                ...
                <div key={medicine.id} className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl">
                  <div className="flex justify-between items-start mb-4">
                    <div className="flex-1">
                      ...
                      <p className="text-sage-700">{medicine.strength} • {medicine.form}</p>
                    </div>
                  ...
                  <div className="space-y-3 mb-4">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sage-700">{medicine.manufacturer}</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Activity className="w-4 h-4 text-sage-700" />
                      <span className="text-sage-700">Stock: {medicine.stockQuantity || 0}</span>
                    </div>
                    {medicine.price && (
                      <div className="flex items-center space-x-2">
                        <span className="text-sage-700">₹</span>
                        <span className="text-sage-700">{medicine.price}</span>
                      </div>
                    )}
                  </div>
                  ...
                  {medicine.description && (
                    <div className="mb-4">
                      <p className="text-sm text-sage-700 line-clamp-2">{medicine.description}</p>
                    </div>
                  )}
                  ...
                  <div className="flex space-x-2">
                    <button
                      ...
                      className="flex-1 px-3 py-2 bg-sage-500 hover:bg-sage-600 text-white rounded-lg text-sm transition-colors flex items-center justify-center space-x-2"
                    >
          ...
          <div className="bg-slate-800 border border-white/10 rounded-2xl p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-start mb-6">
              ...
              <button
                ...
                className="text-sage-700 hover:text-white"
              >
                <X className="w-6 h-6" />
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-sage-700 mb-2">Medicine Name *</label>
                  <input
                    type="text"
                    value={formData.name}
                ...
                <div>
                  <label className="block text-sm font-medium text-sage-700 mb-2">Strength *</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-sage-700 mb-2">Form *</label>
                  <select
                    value={formData.form}
                ...
                <div>
                  <label className="block text-sm font-medium text-sage-700 mb-2">Manufacturer *</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-sage-700 mb-2">Price (₹)</label>
                  <input
                    type="number"
                    step="0.01"
                ...
                <div>
                  <label className="block text-sm font-medium text-sage-700 mb-2">Stock Quantity</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-sage-700 mb-2">Reorder Level</label>
                  <input
                    type="number"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-sage-700 mb-2">Side Effects</label>
                  <textarea
                ...
                <div>
                  <label className="block text-sm font-medium text-sage-700 mb-2">Contraindications</label>
                  <textarea
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-sage-700 mb-2">Dosage Instructions</label>
                  <textarea
                ...
                <div>
                  <label className="block text-sm font-medium text-sage-700 mb-2">Storage Instructions</label>
                  <textarea
              ...
              <div>
                <label className="flex items-center space-x-2">
                  <input
                    ...
                    className="rounded border-white/20 bg-white/5 text-sage-600 focus:ring-blue-400"
                  />
                  <span className="text-sm font-medium text-sage-700">Active Medicine</span>
                </label>
              </div>
