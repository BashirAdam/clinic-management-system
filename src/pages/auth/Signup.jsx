          ...
          <div className="backdrop-blur-xl bg-white/90 border border-sage-200 rounded-3xl p-8 shadow-2xl shadow-sage-200/60">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-xs text-sage-700">Minimum 6 characters required</p>
              </div>
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white/5 text-sage-700">Already have an account?</span>
              </div>
            </div>
