...
export default function PaymentProcessing() {
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      ...
      default:
        return { icon: Clock, color: 'text-sage-700', bgColor: 'bg-slate-500/20' }
    }
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-sage-50 via-sage-100 to-white text-sage-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sage-700">Loading invoices...</p>
        </div>
      </div>
    )
  }
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-sage-700">Process payments for pending invoices</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto p-6">
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl mb-6">
          <div className="max-w-md">
            <label className="block text-sm font-medium text-sage-700 mb-2">Search Invoices</label>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          {filteredInvoices.length === 0 ? (
            <div className="col-span-full text-center py-12">
              <DollarSign className="w-16 h-16 text-sage-700 mx-auto mb-4" />
              <p className="text-sage-700 text-lg">No pending invoices found</p>
            ...
            filteredInvoices.map((invoice) => {
              ...
              return (
                <div key={invoice.id} className="bg-white border border-sage-200 rounded-2xl p-6 backdrop-blur-xl hover:bg-sage-50 transition-colors">
                  {/* Invoice Header */}
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className="text-sm text-sage-700">{invoice.patientPhone}</span>
                    </div>
                    <div className="flex items-center space-x-2">
                  ...
                  <div className="flex space-x-2">
                    ...
                    <Link
                      ...
                      className="px-4 py-2 bg-sage-500 hover:bg-sage-600 text-white rounded-lg transition-colors flex items-center justify-center"
                      title="View Invoice"
                    >
      ...
      {paymentModal && selectedInvoice && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-slate-800 border border-white/10 rounded-2xl p-6 max-w-md w-full mx-4">
            ...
            <div className="mb-4">
              ...
              <div className="grid grid-cols-3 gap-2">
                {[
                  ...
                  { value: 'card', label: 'Card', icon: CreditCard, color: 'text-sage-600' },
            ...
            {/* Payment Amount */}
            <div className="mb-4">
              <label className="block text-sm font-medium text-sage-700 mb-2">Payment Amount (₹)</label>
              <input
                type="number"
                min="0"
                step="0.01"
            ...
            {/* Reference Number */}
            <div className="mb-4">
              <label className="block text-sm font-medium text-sage-700 mb-2">Reference Number</label>
              <input
                type="text"
