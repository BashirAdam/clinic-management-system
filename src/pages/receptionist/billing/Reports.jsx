    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-sage-50 via-sage-100 to-white text-sage-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sage-700">Loading reports...</p>
        </div>
      </div>
    )
  }
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-sage-700">Financial analytics and insights</p>
            </div>
          </div>
          ...
          <div className="flex space-x-3">
            ...
            <button
              ...
              className="px-4 py-2 bg-sage-500 hover:bg-sage-600 text-white rounded-lg transition-colors flex items-center space-x-2"
            >
              <Download className="w-4 h-4" />
      ...
      <main className="max-w-7xl mx-auto p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl">
            ...
            <p className="text-sm text-sage-700 mt-2">In selected period</p>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl">
            ...
            <p className="text-sm text-sage-700 mt-2">Invoice value</p>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl">
            ...
            <p className="text-sm text-sage-700 mt-2">Paid invoices</p>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl">
            ...
            <p className="text-sm text-sage-700 mt-2">Received amount</p>
          </div>
        </div>
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-sage-700">({stats.totalInvoices > 0 ? ((stats.paidInvoices / stats.totalInvoices) * 100).toFixed(1) : 0}%)</span>
                </div>
              </div>
              <div className="flex justify-between items-center">
                <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-sage-700">({stats.totalInvoices > 0 ? ((stats.pendingInvoices / stats.totalInvoices) * 100).toFixed(1) : 0}%)</span>
                </div>
              </div>
              <div className="flex justify-between items-center">
                <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-sage-700">({stats.totalInvoices > 0 ? ((stats.overdueInvoices / stats.totalInvoices) * 100).toFixed(1) : 0}%)</span>
                </div>
              </div>
            </div>
          </div>
              ...
              {Object.entries(stats.paymentMethods).map(([method, amount]) => (
                <div key={method} className="flex justify-between items-center">
                  <div className="flex items-center space-x-2">
                    ...
                    {method === 'card' && <CreditCard className="w-4 h-4 text-sage-600" />}
                    {method === 'online' && <Globe className="w-4 h-4 text-purple-400" />}
                    <span className="capitalize">{method}</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <span className="font-medium">₹{amount.toLocaleString()}</span>
                    <span className="text-sm text-sage-700">({stats.totalPaymentAmount > 0 ? ((amount / stats.totalPaymentAmount) * 100).toFixed(1) : 0}%)</span>
                  </div>
                </div>
              ))}
            </div>
              ...
              <div key={payment.id} className="flex items-center justify-between p-4 bg-white/5 rounded-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-sage-700">Invoice #{payment.invoiceNumber}</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="font-medium text-green-400">₹{payment.amount?.toLocaleString()}</p>
                  <p className="text-sm text-sage-700 capitalize">{payment.method}</p>
                </div>
              </div>
            ))}
          </div>
