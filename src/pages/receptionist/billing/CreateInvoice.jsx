        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-sage-700">{isEditing ? 'Modify existing invoice details' : 'Generate invoice for patient services'}</p>
            </div>
          </div>
        </div>
      </header>
            ...
            <div className="mb-4">
              ...
              <div className="flex space-x-3">
                <button
                  ...
                  className="flex-1 bg-sage-500 hover:bg-sage-600 text-white px-4 py-3 rounded-lg transition-colors flex items-center justify-center space-x-2"
                >
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      {selectedPatient.email && (
                        <div className="text-sm text-sage-700 mt-1">{selectedPatient.email}</div>
                      )}
                      {selectedPatient.address && (
                        <div className="text-sm text-sage-700 mt-1">{selectedPatient.address}</div>
                      )}
                    </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  <button
                    ...
                    className="bg-blue-500/20 hover:bg-blue-500/30 border border-sage-200 text-sage-600 px-3 py-2 rounded-lg transition-colors text-sm"
                  >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 max-h-60 overflow-y-auto">
                  {commonServices.map((service, index) => (
                    ...
                    >
                      ...
                      <div className="text-xs text-sage-700">₹{service.unitPrice}</div>
                    </button>
                  ))}
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white/10 rounded-lg p-4 space-y-3">
                <div className="flex justify-between">
                  <span className="text-sage-700">Subtotal:</span>
                  <span className="font-medium">₹{invoiceData.subtotal.toLocaleString()}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sage-700">Tax ({invoiceData.taxRate}%):</span>
