    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-sage-50 via-sage-100 to-white text-sage-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sage-700">Loading billing data...</p>
        </div>
      </div>
    )
  }
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-sage-700">Manage invoices, payments, and billing</p>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl">
            ...
            <p className="text-3xl font-bold text-sage-600">{stats.totalInvoices}</p>
            <p className="text-sm text-sage-700 mt-2">All time</p>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl">
            ...
            <p className="text-sm text-sage-700 mt-2">Awaiting payment</p>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl">
            ...
            <p className="text-sm text-sage-700 mt-2">Today</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl">
            ...
            <p className="text-2xl font-bold text-sage-600">${stats.cardPayments.toLocaleString()}</p>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-sage-700">Manage all invoices</p>
                </div>
              </div>
            </Link>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-sage-700">Handle payments</p>
                </div>
              </div>
            </Link>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-sage-700">Generate reports</p>
                </div>
              </div>
            </Link>
          </div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl">
          ...
          {recentInvoices.length === 0 ? (
            <p className="text-sage-700 text-center py-8">No invoices found</p>
          ) : (
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-white/10">
                    ...
                    <th className="text-left py-3 px-4 text-sage-700 font-medium">Status</th>
                    ...
                    <tr key={invoice.id} className="border-b border-white/5">
                      ...
                      <td className="py-3 px-4">
                        <div>
                          ...
                          <p className="text-sm text-sage-700">{invoice.patientPhone}</p>
                        </div>
                      </td>
                      <td className="py-3 px-4">
                      ...
                      <td className="py-3 px-4">
                        <div className="flex space-x-2">
                          <Link
                            ...
                            className="text-sage-600 hover:text-blue-300"
                            title="View Invoice"
                          >
