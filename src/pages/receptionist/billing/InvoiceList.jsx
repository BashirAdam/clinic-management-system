...
export default function InvoiceList() {
  ...
  const getPaymentMethodIcon = (method) => {
    switch (method) {
      ...
      case 'card':
        return { icon: CreditCard, color: 'text-sage-600' }
      case 'online':
        return { icon: Globe, color: 'text-purple-400' }
      default:
        return { icon: DollarSign, color: 'text-sage-700' }
    }
  }
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-sage-700">View and manage all invoices</p>
            </div>
          </div>
          <Link
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl">
          {filteredInvoices.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-sage-700 text-lg">No invoices found</p>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-white/10">
                    ...
                    <th className="text-left py-3 px-4 text-sage-700 font-medium">Payment Method</th>
                      ...
                      <tr key={invoice.id} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                        ...
                        <td className="py-3 px-4">
                          {invoice.paymentMethod ? (
                            ...
                            <span className="text-sage-700 text-sm">Not specified</span>
                          )}
                        </td>
