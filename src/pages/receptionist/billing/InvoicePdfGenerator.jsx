...
export default function InvoicePdfGenerator() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-sage-50 via-sage-100 to-white text-sage-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sage-700">Loading invoice...</p>
        </div>
      </div>
    )
  }
  ...
  if (!invoice) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-sage-50 via-sage-100 to-white text-sage-900 flex items-center justify-center">
        <div className="text-center">
          <p className="text-sage-700">Invoice not found</p>
        </div>
      </div>
    )
  }
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-sage-700">#{invoice.invoiceNumber}</p>
            </div>
          </div>
        ...
        <div className="bg-white text-gray-900 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              <div>
                <h2 className="text-lg font-semibold text-sage-700 mb-4 flex items-center space-x-2">
              ...
              <div>
                ...
                <div className="space-y-2">
                  <p><span className="font-medium">Invoice #:</span> <span className="font-mono text-sage-700">{invoice.invoiceNumber}</span></p>
            ...
            {/* Invoice Items */}
            <div className="mb-8">
              <h2 className="text-lg font-semibold text-sage-700 mb-4">Invoice Items</h2>
