        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-sage-700">Manage patient tokens for today's appointments</p>
            </div>
          </div>
          <LogoutButton />
        </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-sage-600">{appointments.length}</div>
                <div className="text-sm text-sage-700">Total Appointments</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-sage-700">Tokens Generated</div>
              </div>
          ...
          {loading ? (
            <div className="flex items-center justify-center min-h-96">
              <div className="text-center">
                ...
                <p className="text-sage-700">Loading appointments...</p>
              </div>
            </div>
          ) : filteredAppointments.length === 0 ? (
            <div className="p-8 text-center">
              <div className="text-sage-700 text-lg mb-2">No appointments found</div>
                      ...
                      <tr key={appointment.id} className="hover:bg-white/5 transition-colors">
                          ...
                          {appointment.tokenNumber ? (
                            <div className="flex items-center space-x-2">
                              ...
                              <button
                                ...
                                className="p-2 text-sage-600 hover:text-blue-300 transition-colors"
                                title="Print Token"
                              >
                        ...
                        <td className="px-6 py-4">
                          <div className="space-y-1">
                            ...
                            <div className="text-sm text-sage-700">{appointment.doctorName}</div>
                          </div>
                        </td>
