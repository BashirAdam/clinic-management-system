    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-sage-50 via-sage-100 to-white text-sage-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-xl text-sage-700">Loading...</p>
        </div>
      </div>
    )
  }
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex items-center justify-center space-x-3 mb-2">
            <div className="w-12 h-12 bg-blue-500/20 rounded-xl flex items-center justify-center">
              <Hash className="w-8 h-8 text-sage-600" />
            </div>
      ...
      <main className="max-w-4xl mx-auto p-6">
        ...
        {nextToken && (
          <div className="bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-400/30 rounded-3xl p-8 backdrop-blur-xl mb-8 text-center">
            <div className="mb-6">
              <h2 className="text-2xl font-bold text-sage-600 mb-2">Next Patient</h2>
              <div className="w-24 h-24 bg-blue-500/30 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-4xl font-bold text-sage-600">{nextToken.tokenNumber}</span>
              </div>
              <div className="text-center">
        ...
        {!currentToken && !nextToken && (
          <div className="bg-white/5 border border-white/10 rounded-3xl p-12 backdrop-blur-xl text-center">
            <div className="w-24 h-24 bg-slate-500/20 rounded-full flex items-center justify-center mx-auto mb-6">
              <AlertCircle className="w-12 h-12 text-sage-700" />
            </div>
            <h2 className="text-2xl font-bold text-sage-700 mb-4">No Active Tokens</h2>
